/*
 * awnn_internal.h — Internal structures for awnn VIPLite wrapper
 *
 * Vendored from ZIFENG278/ai-sdk (examples/libawnn_viplite/)
 * Modified: replaced Android <log/log.h> with fprintf-based logging
 */

#ifndef _AWNN_INTERNAL_H_
#define _AWNN_INTERNAL_H_
...
/* Logging — replaces Android ALOG* macros from <log/log.h> */
...
static inline vip_uint64_t GetTime(void)
{
    struct timeval time;
